...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'OneAPM App'),
    );
  }
}
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return SampleApp(); // RandomWords(); // NewRoute();
                }));
              },
            )
...
class NewRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // );
    // 加载本地图片
    var image1 = Image.asset('assets/image/OneAPMLogo.png');
    ...
    var scaffold = Scaffold(
          ...
          // image: AssetImage('assets/image/OneAPMLogo')
          // var img = Image.asset('assets/image/OneAPMLogo')
